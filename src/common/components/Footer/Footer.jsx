import Logo from "../../assets/images/puglogo.png";
    ...
    <div className="w-full mx-auto flex justify-end">
      <footer className="p-4 bg-white bg-opacity-70 sm:p-6 dark:bg-gray-800 dark:bg-opacity-80">
        ...
        <div className="my-5 md:flex md:justify-between">
          <div className="grid grid-cols-2 gap-9 sm:gap-6 sm:grid-cols-3">
            <div>
            ...
            <div>
              ...
              <ul>
                <li className="mb-4 text-gray-600 hover:underline dark:text-gray-400">
